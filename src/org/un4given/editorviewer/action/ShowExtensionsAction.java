...
public class ShowExtensionsAction extends Action {
	 ...
	 */
	public ShowExtensionsAction(EditorViewer viewer){
		_viewer = viewer;
		setImageDescriptor(EditorViewerPlugin.getImageDescriptor(Messages.getString("CloseAction.0")));                  //$NON-NLS-1$
		setToolTipText("Show Extensions");
		setText("Show Extensions");
		setDescription("Show Extensions");
		setChecked(true);
	}
	 ...
	 */
	public void run(){
		_viewer.setShowExtensions(isChecked());
	}
